...
> Index du dépôt, généré par `python scripts/nexus_boussole.py` le 2026-08-31 04:40.
...
|---|---|---|---|---|---|
| Contrat | `.claude/CLAUDE.md` | Contrat d'exploitation de la plateforme | 104 Ko | 2026-08-30 | `838afda900b3e9e0` |
...
| Configuration | `litellm_config.yaml` | Modèles, routeurs, fallbacks — mi-généré, mi-manuel | 59 Ko | 2026-08-31 | `5c96414b214c94ad` |
| Inventaire | `cloud_models.txt` | Catalogue Ollama Cloud, généré, droits annotés | 551 o | 2026-08-31 | `4cacc5ffa16f30eb` |
...
| Pont | `Set-ClaudeModel.ps1` | Choix explicite du mode d'exécution de Claude Code | 12 Ko | 2026-08-29 | `9e2a59fe81edff69` |
| Pont | `tools/nexus-mcp/server.js` | Serveur MCP : les modèles comme outils | 106 Ko | 2026-08-31 | `2df945e54f8470df` |
| Génération | `scripts/Update-NexusModels.ps1` | Orchestrateur de mise à jour | 12 Ko | 2026-08-30 | `dc4dc63208ecbb38` |
| Génération | `scripts/nexus_generate.py` | Régénère les zones AUTOGEN | 73 Ko | 2026-08-31 | `d9aef51096bd1ec4` |
...
| Vérification | `scripts/nexus_capability.py` | Profil matériel et verdict par modèle | 27 Ko | 2026-08-30 | `d12b9c73d1ed8a18` |
| Vérification | `scripts/nexus_mcp_probe.py` | Sonde les outils du pont MCP | 10 Ko | 2026-08-29 | `30065350e667d322` |
| Vérification | `scripts/nexus_test.py` | Suite forward / reverse / policy / code | 130 Ko | 2026-08-31 | `5b11d627d0f028be` |
| Vérification | `scripts/nexus_validate.py` | Intégrité — bloque tout redémarrage douteux | 25 Ko | 2026-08-30 | `13d985178ff1a6e0` |
...
| Automatisation | `scripts/Register-NexusAutoUpdate.ps1` | Tâche planifiée quotidienne | 10 Ko | 2026-08-30 | `3784e5f8e5c6921d` |
| Exploitation | `scripts/backup.ps1` | Sauvegarde configuration et volumes | 9 Ko | 2026-08-30 | `61f3cc6e51940721` |
...
| Rituel | `rituels/BOUSSOLE.md` | Cet index | 25 Ko | 2026-08-29 | `81a91f7d0ac85614` |
| Rituel | `rituels/CHECKLIST_COCKPIT.MD` | Sujets ouverts | 114 Ko | 2026-08-31 | `237d3659f6108cc2` |
...
| Rituel | `rituels/STATE.md` | État mesuré — généré, ne pas éditer | 3 Ko | 2026-08-31 | `2311a9692f7783e6` |
| Rituel | `scripts/nexus_boussole.py` | Régénère cette boussole | 12 Ko | 2026-08-31 | `dc6124843a78eb21` |
| Rituel | `scripts/nexus_state.py` | Régénère STATE.md par mesure | 18 Ko | 2026-08-31 | `0571d9b2693cbdbc` |
| Documentation | `README.md` | Vue d'ensemble et installation | 15 Ko | 2026-08-30 | `1a4065e08babf359` |
...
| Architecture | `.claude/scheduled_tasks.lock` | — | 124 o | 2026-08-30 | `36165fc157b7a2bc` |
| Architecture | `.claude/settings.json` | — | 3 Ko | 2026-08-31 | `af9a1014404b05d5` |
| Architecture | `.claude/settings.local.json` | — | 93 o | 2026-08-29 | `d3810c5c023925e8` |
...
| Architecture | `.gitignore` | — | 1 Ko | 2026-08-31 | `814b27b7cedcf61a` |
| Architecture | `.ruff_cache/.gitignore` | — | 35 o | 2026-08-31 | `9e3a60f1e6ec4ae6` |
| Architecture | `.ruff_cache/0.16.5/10108054744112579873` | — | 2 Ko | 2026-08-31 | `f9faea65c84a955a` |
...
| Architecture | `.ruff_cache/0.16.5/17644524646699821479` | — | 2 Ko | 2026-08-31 | `062124de3de7151f` |
...
| Architecture | `rituels/BOUSSOLE.csv` | — | 20 Ko | 2026-08-29 | `46c0352a1706fa2d` |
...
| Architecture | `rituels/outillage_reference.json` | — | 592 o | 2026-08-31 | `49e5115920487843` |
...
| Architecture | `scripts/epreuve_cablage.py` | — | 3 Ko | 2026-08-31 | `6b228edefcd2096b` |
| Architecture | `scripts/epreuve_garde_plan.py` | — | 5 Ko | 2026-08-31 | `eb1add6218bc1470` |
| Architecture | `scripts/nexus.ps1` | — | 10 Ko | 2026-08-31 | `a37dbad28132e74b` |
| Architecture | `scripts/nexus_agent.py` | — | 49 Ko | 2026-08-31 | `2d6c4c2db09b2599` |
| Architecture | `scripts/nexus_agent.py.avant-patch` | — | 49 Ko | 2026-08-30 | `310e3bab9ab3d1fb` |
| Architecture | `scripts/nexus_bench.py` | — | 32 Ko | 2026-08-30 | `ad55dc2c3014e5e5` |
| Architecture | `scripts/nexus_cablage.py` | — | 14 Ko | 2026-08-31 | `206c5d4926f501ac` |
| Architecture | `scripts/nexus_conformite.py` | — | 59 Ko | 2026-08-31 | `e4fe086c3e6440cd` |
| Architecture | `scripts/nexus_conformite.py.avant-patch` | — | 35 Ko | 2026-08-30 | `1ccee0e7fa3cffd4` |
| Architecture | `scripts/nexus_doc.py` | — | 16 Ko | 2026-08-31 | `4a9bce50b6fd40d3` |
...
| Architecture | `scripts/nexus_garde_agent.py` | — | 9 Ko | 2026-08-31 | `e3b42670c6478e9f` |
| Architecture | `scripts/nexus_garde_edition.py` | — | 5 Ko | 2026-08-30 | `71918bdcf781c2d9` |
| Architecture | `scripts/nexus_garde_lecture.py` | — | 7 Ko | 2026-08-30 | `7d76a6e320a06990` |
| Architecture | `scripts/nexus_garde_shell.py` | — | 7 Ko | 2026-08-30 | `eef9e2e157fcc3d1` |
| Architecture | `scripts/nexus_import.py` | — | 6 Ko | 2026-08-30 | `e6477fe5ccdc7993` |
| Architecture | `scripts/nexus_outillage.py` | — | 27 Ko | 2026-08-31 | `1431a77a4fef918a` |
...
| Architecture | `scripts/nexus_releve.py` | — | 36 Ko | 2026-08-31 | `b5c7717f6213e54a` |
| Architecture | `scripts/nexus_reprise.py` | — | 15 Ko | 2026-08-31 | `c9dabab3a183c40f` |
| Architecture | `scripts/nexus_rituel.py` | — | 15 Ko | 2026-08-31 | `8c959b1225337566` |
...
| Architecture | `scripts/nexus_traque.py` | — | 15 Ko | 2026-08-31 | `24c38910d77e4be8` |
| Architecture | `scripts/nexus_valide.py` | — | 30 Ko | 2026-08-30 | `56a57f1e606cf477` |
...
| Architecture | `tools/nexus-mcp/epreuve_semaphore.js` | — | 9 Ko | 2026-08-30 | `478a7f3e8e7dc905` |
