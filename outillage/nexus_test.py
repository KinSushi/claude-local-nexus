...
def test_semaphore_local() -> None:
    ...
    jouer_epreuve_node("epreuve_concurrence_cloud.js", "concurrence cloud du pont",
                       "SEMAPHORE INTERNE DU PONT : defaut 10 et valeur invalide refusee, comme nexus_agent ?")
